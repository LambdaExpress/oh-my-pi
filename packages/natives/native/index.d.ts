...
export declare class EditSession {
   ...
   */
  preloadVirtualResource(resource: EditVirtualResource): Promise<void>
...
export declare class EditStore {
   ...
   * a local path.
   */
  recordSnapshotForKey(canonicalKey: string, text: string, seenLines?: Array<number> | undefined | null): string
  /**
   ...
   * key.
   */
  recordSeenLinesForKey(canonicalKey: string, tag: string, lines: Array<number>): void
  /**
 ...
 */
export interface EditVirtualResource {
  canonicalUrl: string
  displayUrl: string
  content?: string
}
