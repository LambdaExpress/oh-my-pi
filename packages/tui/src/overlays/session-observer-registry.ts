...
export class SessionObserverRegistry {
	...
	subscribeToEventBus(eventBus: EventBusLike, subagentEventBus: EventBusLike = eventBus): void {
		...
		const buses = eventBus === subagentEventBus ? [eventBus] : [eventBus, subagentEventBus];
