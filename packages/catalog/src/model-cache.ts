...
// credentials. v11 deletes rows written by either pre-merge v10 lineage:
// reset-branch rows may persist headers, while upstream rows predate the
// distinct max-effort route for Devin GPT-5.6. The omission metadata records
