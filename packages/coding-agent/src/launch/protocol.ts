...
/**
 * Immutable launch specification retained for restart and inspection, plus the
 * local graceful-stdin-close extension.
 */
export interface DaemonSpec extends HubDaemonSpec {
