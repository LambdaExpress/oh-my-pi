...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/ssh/host-registry",
	"@oh-my-pi/pi-coding-agent/ssh/password-auth",
	...
	"@oh-my-pi/pi-coding-agent/tools/pwsh",
	...
	"@oh-my-pi/pi-coding-agent/tools/ssh-session",
	...
	"@oh-my-pi/pi-coding-agent/tools/worktree",
	...
	"@oh-my-pi/pi-coding-agent/worktree/args",
	"@oh-my-pi/pi-coding-agent/worktree/dirty-transfer",
	"@oh-my-pi/pi-coding-agent/worktree/include",
	"@oh-my-pi/pi-coding-agent/worktree/manager",
	"@oh-my-pi/pi-coding-agent/worktree/metadata",
	"@oh-my-pi/pi-coding-agent/worktree/selector",
	"@oh-my-pi/pi-coding-agent/worktree/session",
	"@oh-my-pi/pi-coding-agent/worktree/snapshot",
	"@oh-my-pi/pi-coding-agent/worktree/submodules",
	"@oh-my-pi/pi-coding-agent/worktree/types",
