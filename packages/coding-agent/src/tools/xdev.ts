...
export class XdevRegistry {
	/** Discoverable built-ins mounted at construction or updated explicitly. */
	...
	/** Replace or remove one built-in device without disturbing dynamic mounts. */
	setBuiltin(name: string, tool: Tool | null): void {
		if (tool) {
