...
export class SessionManager {
	 ...
	 * Artifacts are copied recursively by default; nested agents that deliberately share their parent's
...
export interface PersistedSessionInit {
	...
	task: string;
	tools: string[];
	/** Tools the subagent mounted through the `xd://` transport; revived as explicit grants. */
	mountedXdevTools?: string[];
	agent?: string;
	modelRole?: string;
	resolvedModel?: string;
