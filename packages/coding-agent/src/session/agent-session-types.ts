import type { Agent, AgentMessage, AgentTool, AgentToolResult, StreamFn, ThinkingLevel } from "@oh-my-pi/pi-agent-core";
import type {
	Context,
	ImageContent,
	Message,
...
export interface AgentSessionConfig {
	...
	/** Dispose and unregister every child agent in a retired scope. */
	releaseAgentScope?: (scopeId: string) => Promise<void>;
	/** Rebind the long-lived main agent reference after a session scope changes. */
