...
export const SETTINGS_SCHEMA = {
	...
	// tiers. Premium models also keep the configured window as a floor.
	// Off preserves default windows and caps premium models before requests
	// cross into their higher pricing tier.
	extendedContext: {
		type: "boolean",
		default: false,
		ui: {
