...
- Restored the 17.4 annotated context gauge as the status-line default, including its theme-driven 50/70/90 percent color tiers, token thresholds, and pulsing async-compaction icon; percentage/window numbers render in the context segment instead of being embedded in the line.
